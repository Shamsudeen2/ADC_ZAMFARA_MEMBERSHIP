  ...
  <div class="navbar-wrapper">
    <div class="m-header">
      <a href="#" class="b-brand text-primary">
        ...
        <h1 class=" bg-light-success rounded-pill">ADC</h1>
      </a>
    </div>
      ...
      <ul class="pc-navbar">
            ...
            <li class="pc-item pc-hasmenu">
              <a href="index.php" class="pc-link">
                ...
                <span class="pc-mtext text-success" data-i18n="Register Form">Register Form</span>
              </a>
             
            </li>
          
            <li class="pc-item">
              <a href="card.php" class="pc-link">
                <span class="pc-micon">
                <i data-feather="map"></i>
                </span>
                <span class="pc-mtext">Print Card</span>
              </a>
            </li>
            ...
            <li class="pc-item">
              <a href="../index.php" class="pc-link">
                <span class="pc-micon">
                <i class="ti ti-device-tv card-icon"></i>
                </span>
